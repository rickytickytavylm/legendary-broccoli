...
window.SISTEMA_THERAPY_GROUPS = {
  calm: {
    ...
    image: '/assets/webp/therapy-groups/calm-mobile.webp',
    imageMobile: '/assets/webp/therapy-groups/calm-mobile.webp',
    imageDesktop: '/assets/webp/therapy-groups/calm-desktop.webp',
  ...
  body: {
    ...
    image: '/assets/webp/therapy-groups/body-mobile.webp',
    imageMobile: '/assets/webp/therapy-groups/body-mobile.webp',
    imageDesktop: '/assets/webp/therapy-groups/body-desktop.webp',
  ...
  relationships: {
    ...
    image: '/assets/webp/therapy-groups/relationships-mobile.webp',
    imageMobile: '/assets/webp/therapy-groups/relationships-mobile.webp',
    imageDesktop: '/assets/webp/therapy-groups/relationships-desktop.webp',
  ...
  selfworth: {
    ...
    leader: 'Владимир Земелькин',
    image: '/assets/webp/therapy-groups/selfworth-mobile.webp',
    imageMobile: '/assets/webp/therapy-groups/selfworth-mobile.webp',
    imageDesktop: '/assets/webp/therapy-groups/selfworth-desktop.webp',
  ...
  selfstudy: {
    ...
    image: '/assets/webp/therapy-groups/selfstudy-mobile.webp',
    imageMobile: '/assets/webp/therapy-groups/selfstudy-mobile.webp',
    imageDesktop: '/assets/webp/therapy-groups/selfstudy-desktop.webp',
  ...
  communication: {
    ...
    image: '/assets/webp/therapy-groups/communication-mobile.webp',
    imageMobile: '/assets/webp/therapy-groups/communication-mobile.webp',
    imageDesktop: '/assets/webp/therapy-groups/communication-desktop.webp',
...
window.getTherapyGroupCardState = function getTherapyGroupCardState(routeKey) {
  ...
  return {
    ...
    leader: `Ведущий: ${cfg.leader}`,
    desc: 'Терапевтическая группа — это Zoom-вебинары, малые группы со специалистом и живой чат участников. Идёт набор по вашему направлению: оставьте заявку — ведущий свяжется о старте.',
    cta: 'Записаться',
    showPro: false,
  };
};
